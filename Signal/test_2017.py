...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/grid_mnt/t3storage3/athachay/trippleHiggs/hhhTo4b2g/flashggFinalFits/CMSSW_10_2_13/src/flashggFinalFit/Trees2WS/jan16_xSecUpdated/ws_2017/',
  'inputWSFile': ['doubleH_2017_M125_13TeV_doubleH.root','singleH_UL17_M125_13TeV_singleH.root','doubleH_ttHH_privateUL17forRUNII_M125_13TeV_ttHH.root','doubleH_vHH_privateUL17forRUNII_M125_13TeV_vHH.root','sig_ggHHH_UL17_13TeV_ggHHH.root'], #['singleH_125_13TeV_singleH.root']
  #'procs':'c3_4_d4_9', # if auto: inferred automatically from filenames
  'procs':'doubleH,singleH,ttHH,vHH,ggHHH', # if auto: inferred automatically from filenames
